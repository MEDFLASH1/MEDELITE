...
export function ManageSection() {
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">Gestionar</h1>
        <p className="text-gray-400">Administra tus decks y flashcards</p>
      </div>

      <div className="card text-center py-16">
        <div className="text-6xl mb-4">⚙️</div>
        <h3 className="text-2xl font-semibold text-white mb-4">Sección de Gestión</h3>
